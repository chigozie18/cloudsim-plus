...
public class Scenario8 {
	...
	private Scenario8() {
		...
		hostList = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter1_Hosts.csv");
		hostList2 = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter2_Hosts.csv");
		hostList3 = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter3_Hosts.csv");
		...
		vmList3 = CloudCreator.createVmsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter3_Vms.csv");		      

		cloudletList = CloudCreator.createCloudletsFromFile2(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter1_Cloudlets.csv");
		cloudletList2 = CloudCreator.createCloudletsFromFile2(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part2/Scenario8/Datacenter2_Cloudlets.csv");
