...
public class Scenario4 {
    ...
    private Scenario4() {
		...
		hostList = CloudCreator.createHostsFromFile(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter1_Hosts.csv");
		hostList2 = CloudCreator.createHostsFromFile(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter2_Hosts.csv");
		...
		vmList = CloudCreator.createVmsFromFile(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter1_Vms.csv");		      
		vmList2 = CloudCreator.createVmsFromFile(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter2_Vms.csv");		      

		cloudletList = CloudCreator.createCloudletsFromFile2(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter1_Cloudlets.csv");
		cloudletList2 = CloudCreator.createCloudletsFromFile2(localDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Part1/Scenario4/Datacenter2_Cloudlets.csv");
