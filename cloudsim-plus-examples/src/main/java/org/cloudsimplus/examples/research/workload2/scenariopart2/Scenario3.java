...
public class Scenario3 {
	...
	private Scenario3() {
		...
		hostList = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter1_Hosts.csv");
		hostList2 = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter2_Hosts.csv");
		hostList3 = CloudCreator.createHostsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter3_Hosts.csv");
		...
		vmList = CloudCreator.createVmsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter1_Vms.csv");		      
		vmList2 = CloudCreator.createVmsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter2_Vms.csv");		
		vmList3 = CloudCreator.createVmsFromFile(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter3_Vms.csv");		      

		cloudletList = CloudCreator.createCloudletsFromFile2(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter1_Cloudlets.csv");
		cloudletList2 = CloudCreator.createCloudletsFromFile2(workingDirectory + "/cloudsim-plus-examples/Test_Data/Research Scenarios/Workload2/Part2/Scenario3/Datacenter2_Cloudlets.csv");
