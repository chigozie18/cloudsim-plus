...
/**
 * An implementation of {@link DatacenterBroker} that uses a worst
 ...
 */
public class DatacenterBrokerWorstMap2 extends DatacenterBrokerSimple {
	 ...
	 */
	public DatacenterBrokerWorstMap2(final CloudSim simulation) {
		super(simulation);
	}
