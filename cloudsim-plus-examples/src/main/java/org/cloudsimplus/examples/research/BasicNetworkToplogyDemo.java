...
public class BasicNetworkToplogyDemo {
    ...
    public static void main(String[] args) {
        new BasicNetworkToplogyDemo();
    }
    
    private BasicNetworkToplogyDemo() {
      ...
      //Configure network by mapping CloudSim entities to BRITE entities
        ...
        networkTopology.addLink(datacenter3.getId(), broker1.getId(), 10.0, 10);
        networkTopology.addLink(datacenter1.getId(), datacenter3.getId(), 10.0, 10);
        networkTopology.addLink(datacenter3.getId(), datacenter3.getId(), 10.0, 10);
